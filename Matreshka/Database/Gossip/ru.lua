...
G["<The charger stands proud, eager for battle.>"] = "<Скакун стоит гордо, готовый к битве.>"
G["<The footman stand resolute, muscles tense.>"] = "<Пехотинец стоит непоколебимо, мускулы напряжены.>"
G["<The water elemental is ready to surge.>"] = "<Элементаль воды готов нахлынуть.>"
G["Ah, good of you to come around, Ruusk. Thank you and farewell."] = "Хорошо, что заглянул, Рууск. Спасибо и прощай."
G["Ah, guests of the Master. I hope you've been watching your step in here."] = "А, гости хозяина. Надеюсь, ты здесь смотришь под ноги."
G["All inquiries regarding Medivh should be directed to Moroes, the Tower Steward. I myself know very little about the Master's business. I believe several nobles are currently having an audience with Moroes in the Banquet Hall, if you wish to inquire further."] = "Все вопросы, касающиеся Медива, лучше задавать Мороузу, дворецкому. Я сам слишком мало знаю о делах хозяина. Если хочешь узнать больше... думаю, у Мороуза в пиршественном зале сейчас находится несколько дворян."
G["Ar'tor's lifeless body remains suspended in mid-air by demonic magic. They take from him, even in death..."] = "Безжизненное тело Ар'тора висит в воздухе, удерживаемое магией демонов. Даже после смерти они не оставили его в покое!"
G["Aran has been defeated? Yes... I can sense his grip has loosened - if only just a little. But just enough to allow me to do my job as the doorman! Would you like me transport you to the Guardian's Library, $N?"] = "Аран уничтожен? Да... его хватка явно ослабла, но совсем немного. Однако и этого мне хватит, чтобы выполнять свою работу привратника! Не хочешь ли переместиться в Библиотеку Стража, $N?"
G["Are you ready to hear the story of the Cipher of Damnation, $N?"] = "Хочешь, я расскажу тебе о Коде Проклятия, $N?"
G["Borak, I need another bundle of bloodthistle."] = "Борак, мне нужен еще один пучок кровопийки."
G["Continue, please."] = "Пожалуйста, продолжай..."
G["Control Conjured Water Elemental."] = "Управление сотворенным элементалем воды."
G["Control Human Charger."] = "Управление Скакуном."
G["Do I need to go into all the gory details? I think we are both well aware of what Lord Illidan does with those that would oppose his word. Now, I must be going! Farewell, Ruusk! Forever..."] = "Стоит ли вдаваться в кровавые подробности? Думаю, и так ясно, что владыка Иллидан делает с теми, кто ему перечит. Теперь мне нужно идти. Прощай, Рууск! Прощай навсегда..."
G["From here in the Gatehouse, you may travel in one of three directions. The stairs behind me lead to the Grand Ball Room, where guests are currently being entertained. I'm sure you can smell the nearby Stables, and the entrance to Servant's Quarters lies next to the Gatehouse door."] = "Отсюда, из Вестибюля, ты можешь отправиться по одному из трех направлений. Ступени за моей спиной ведут в бальный зал, где сейчас развлекают гостей. Я уверен, ты чувствуешь запах стойл, а вход в комнаты слуг лежит недалеко от двери Вестибюля."
G["How do I find the cipher?"] = "Как мне отыскать Код?"
G["How do you know all of this?"] = "Откуда ты все это знаешь?"
G["How do you navigate the tower?"] = "Как ты управляешь башней?"
G["I am ready to hear your story, Oronok."] = "Я готов услышать твою историю, Оронок."
G["I bring word from Lord Illidan."] = "У меня новости от владыки Иллидана."
G["I need another disguise, Borak. I lost the last one."] = "Мне нужна другая маскировка, Борак. Прежняя утеряна."
G["I should be able to get out here now. Thanks!"] = "Отсюда я теперь смогу выбраться. Спасибо!"
G["I will find your boys and the cipher, Oronok."] = "Я найду и Код, и ребят, Оронок."
G["I'm in need of your skill as a blacksmith, Koren."] = "Корен, я хочу воспользоваться твоим знанием кузнечного дела."
G["Listen to me, peon. We have a process for the delivery and safekeeping of the cipher fragment. The envoy delivers the missive, which is sealed by Lord Illidan. No missive, no transfer."] = "Слушай меня, батрак. У нас свой способ доставки и сохранения фрагмента Кода. Посланник должен предъявить письмо с печатью владыки Иллидана. Нет письма – нет и Кода."
G["Now that you have bested me, test your skills against each other! Take control of either king to begin play."] = "Теперь, когда я повержен, проверьте свои умения в бою друг против друга! Возьмите под контроль одного из королей, чтобы начать игру."
G["Oh? Of course you have papers documenting this request."] = "А? Конечно, у тебя есть бумаги, подтверждающие этот запрос?"
G["Perhaps you did not hear me, Ruusk. I am giving you an order from Illidan himself!"] = "Возможно, ты не расслышал меня, Рууск. Я передаю тебе приказ самого Иллидана!"
G["Please reset the chess board, we would like to play again."] = "Пожалуйста, расставь фигуры заново: мы хотим сыграть еще раз."
G["Please transport me to the Guardian's Library."] = "Пожалуйста, перемести меня в Библиотеку Стража."
G["So what of the cipher now? And your boys?"] = "Что же теперь будет с Кодом? И с ребятами?"
G["The cipher fragment is to be moved. Have it delivered to Zuluhed."] = "Нужно унести фрагмент Кода. Доставь его Зулухеду."
G["Very well. I will return to the Black Temple and notify Lord Illidan of your unwillingness to carry out his wishes. I suggest you make arrangements with your subordinates and let them know that you will be leaving this world soon."] = "Очень хорошо. Я вернусь в Черный храм и уведомлю владыку Иллидана о твоем нежелании исполнять его повеления. Рекомендую тебе дать необходимые распоряжения своим подчиненным и объяснить им, что вскоре ты покинешь этот мир."
G["What do you have for sale, Oronok?"] = "Оронок, что у тебя есть на продажу?"
G["What do you need directions to?"] = "Куда ты хочешь пройти?"
G["What is this place?"] = "Что это за место?"
G["Where is Medivh?"] = "Где Медив?"
G["Who dares interrupt the Grand Commander?"] = "Кто смеет прерывать Верховного командира?"
G["Who is Midnight?"] = "Кто такая Полночь?"
G["Yet what? What is it, Oronok?"] = "Что? Что это, Оронок?!"
G["You must... free... my children..."] = "Ты $gдолжен:должна; освободить... моих детей..."
G["The Cipher of Damnation was kept in Gul'dan's private quarters inside Karabor for twenty years. Ah, that's right, you have no idea what Karabor is, do you? The Black Temple... Aye, now home to Illidan Stormrage. When Illidan took control of the Black Temple, he discovered the cipher. He recognized that the damage to this world had already been done but thought it wise to keep the cipher secure for later use."] = "Код Проклятия находился в частных владениях Гул'дана в Караборе двадцать лет. Ах да, ты же не знаешь, что такое Карабор, не так ли?\n\nЧерный храм...\n\nДа, теперь это дом Иллидана Ярости Бури.\n\nКогда Иллидан захватил Черный храм, он обнаружил там код. Он осознавал, что этот мир уже пострадал, но посчитал разумным оставить код себе для дальнейшего использования."
G["<Ruusk swallows hard.> I... What do you mean?"] = "<Рууск сглатывает.>\n\nЭ... Ты о чем?"
G["When you stand at the Altar of Damnation and see the spirits of the damned, kneeling in prayer, what you do not see is me, standing next to Gul'dan. <Oronok nods.> I told you that I was a lot of things, did I not? One of those 'things' was a lieutenant of Gul'dan. I have done many terrible things in my life. I have slaughtered man, woman, and child alike. Danced in the blood of innocent draenei... yet... <Oronok chokes on his words.>"] = "Когда стоишь у алтаря Проклятия и видишь души проклятых, преклонивших колени в молитве, ты не видишь, что рядом, за Гул'даном, стою я.\n\n<Оронок кивает.>\n\nЯ говорил тебе, что у меня много обличий, так? Одно из таких обличий – лейтенант Гул'дана.\n\nВ своей жизни я совершил немало ужасного. Я истреблял и мужчин, и женщин, и детей. Плясал на костях невинных дренеев, но...\n\n<Оронок запинается.>"
G["Wait. Where are you going? You needed a transfer, correct? Let's just get it done and over with, ok? Zuluhed at Dragonmaw? It will be done. Please let Lord Illidan know that his orders were carried out with the full cooperation of the Eclipsion. I will dispatch Ruul the Darkener to personally deliver the fragment! You heard me right - Ruul..."] = "Погоди! Куда ты? Тебе нужно осуществить передачу, так? Давай сделаем это и все, а? Зулухед в Драконьей Пасти? Будет сделано. Пожалуйста, сообщи владыке Иллидану, что лагерь Затмения охотно помог выполнить его приказ.\n\nЯ отправлю Руула Светокрада лично доставить фрагмент!\n\nДа, ты правильно $gрасслышал:расслышала; – Руула..."
G["I once served Medivh... or pretended to. I helped the Violet Eye keep a close eye on the Master. But now all I can think of is... making horseshoes. Over and over."] = "Когда-то я служил Медиву... Или делал вид. Я помогал Аметистовому Оку пристально следить за хозяином.\n\nНо теперь все, что я могу, – делать подковы. Одну за другой."
G["As I said, the cipher was found by Illidan when he took over the Black Temple. He divided the tome into three parts and charged their care to his minions. My boys... My boys are grown now. When I got word of what Illidan had done with the cipher, I sent my boys to recover the pieces. You must find my boys, $N. You must find them and recover the Cipher of Damnation."] = "Как я уже говорил, Код был найден Иллиданом, когда он захватил Черный храм. Он разделил Код на три части и поручил хранить их своим слугам.\n\nМои мальчики... Мои мальчики уже выросли. Когда я услышал, что Иллидан сделал с Кодом, я послал своих мальчиков вернуть его части.\n\nТы $gдолжен:должна; найти моих мальчиков, $N. Ты $gдолжен:должна; найти их и вернуть Код Проклятия!"
G["I will never forget that day, draenei. Never. Even though I had long since abandoned shamanism in favor of shadow magic, I felt the cut. A sense of loss so profound... I could not explain it to you with mere words. When the tie to the elements was severed, all orcs on Draenor changed. If there was ever any doubt in the power of the shadows, it was washed away with the cresting of the molten lava over the shattered earth."] = "Мне никогда не забыть того дня, дреней. Никогда. Даже я, столь давно предавший шаманство ради темной магии, все еще чувствую потерю. Чувство это столь глубоко... я не могу описать его словами.\n\nКогда связь с духами прервалась, все орки Дренора изменились. Если и возникло сомнение в силах тьмы, то оно было смыто волнами расплавленной лавы, растекшейся по разрушенной земле."
G["Only the most seasoned hunters of Illidan's minions gain access to my wares. You will be considered worthy when your status with the Sha'tar, Cenarion Expedition and the Aldor is exalted."] = "Мои товары доступны лишь самым настойчивым преследователям приспешников Иллидана.\n\nТы станешь $gтаким:такой; только тогда, когда тебя будут превозносить Ша'тар, Кенарийская экспедиция и Алдоры."
G["Very well. The words you seek have a name, $N. They are known as the Cipher of Damnation: The words uttered by Gul'dan himself to shatter this land. The very spell that severed the last remaining tie the orcs had with the elements of Draenor. <Oronok nods.> Aye, it is the cipher that you must reconstruct and ultimately the words of the cipher that you must call."] = "Очень хорошо. У слов, которые ты ищешь, есть название, $N. Они известны как Код Проклятия - слова, которые произнес сам Гул'дан, чтобы раздробить эту землю. Это то самое заклинание, которое разорвало последнюю связь орков со стихиями Дренора.\n\n<Оронок кивает.>\n\nДа, тебе придется восстановить Код и произнести его."
G["Tread lightly, draenei. Beyond this bridge lies hell."] = "Ступай осторожно, дреней. За этим мостом – ад."
G["I... died. Why am I still here? Is there no great hunting ground that I ascend to? No... I must first complete my task. Before I can leave this world, the second part of the Cipher of Damnation must be recovered."] = "Я... умер.\n\nНо почему я еще здесь? Разве нет охотничьих угодий, куда я мог бы отправиться?\n\nНет... Мне нужно закончить свое дело. Прежде чем я покину этот мир, нужно найти вторую часть Кода Проклятия."
G["It is here that Gul'dan severed the tie between orcs and the elemental spirits. His unquenchable thirst for power could not be satiated with the complete annihilation of the draenei. He had to also destroy Draenor, razing the land and siphoning all of its energies for use in his war. Now all that is left are remnants of his madness. Look to the altar, draenei - the land is forever haunted..."] = "Именно здесь Гул'дан нарушил связь между орками и духами стихий. Его неутолимую жажду власти не могло удовлетворить полное уничтожение дренеев. Ему надо было вдобавок уничтожить Дренор, выжечь его землю и высосать его энергию, чтобы использовать ее в битвах.\n\nИ все, что осталось, – осколки его безумия.\n\nПосмотри на алтарь, дреней – земля здесь проклята навеки..."
G["Greetings, traveler. I am Oronok. Please, sit by my fire and warm yourself. Beware the ravenous beasts of the shattered shelf below us!"] = "Здравствуй, путник. Я Оронок. Прошу, присаживайся у огня, погрейся.\n\nТолько осторожней – внизу водятся страшные чудовища!"
G["<The image's head blurs as it turns to take in its surroundings.> If you had seen the Plains of Farahlon, you wouldn't believe this is the same place. Mere months ago, these fields would not have looked out of place in Westfall. All that is gone now, but how and why?"] = "<Голова изображения поворачивается и мутнеет.>\n\nЕсли бы ты видел равнины Фаралона, ты никогда бы не поверил, что это то же самое место. Всего несколько месяцев назад эти поля идеально вписывались в пейзаж Западного края.\n\nТеперь всего этого нет. Но как и почему?"
G["A wave of sickness rushed through me. After the ritual was over, I ran home to my children. I gathered what belongings I could carry in my arms and left with my boys. We ran to the hills and hid. There really was no other option... Not a day goes by that I don't think of the cut. It has taken 20 years to reconnect with the elements. It has taken 20 years for the elements to even begin to heal."] = "Мне вдруг резко подурнело. Когда ритуал окончился, я сразу же побежал домой, к детям. Я собрал все вещи, какие смог унести, и покинул дом вместе с сыновьями. Мы скрылись среди холмов... Другого выхода у нас и в самом деле не было.\n\nНе проходит и дня, чтобы я не думал о расколе. 20 лет ушло на то, чтобы восстановить связь со стихиями. После 20 лет стихии только начали восстанавливать силу."
